# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 15:03:16 2024

@author: armen
"""
import pandas as pd
import ast
meta_crop_data = pd.read_csv('../../Datasets/econ_crop_data/processed_usda_crops_20.csv',index_col=0)
...
columns_to_fill = ['price_2020', 'Production_2020', 'Acres_2020','yield_2020', 
                   'fraction_1', 'price_1', 'yield_1', 'price_2', 'yield_2']
for sel_variable in columns_to_fill:
    meta_crop_data = process_and_fill_variable(meta_crop_data, sel_variable)
meta_crop_data['final_fraction_2'] = 1- meta_crop_data['final_fraction_1']

meta_crop_data = meta_crop_data[['Crop_OpenAg', 'County', 'HR_NAME', 'final_price_2020','final_yield_2020', 
                                 'final_fraction_1','final_fraction_2','final_price_1', 'final_yield_1', 'final_price_2', 'final_yield_2']]
meta_crop_data.set_index(['Crop_OpenAg', 'County', 'HR_NAME'], inplace=True)
meta_crop_data.columns = meta_crop_data.columns.str.replace('final_', '', regex=True)

meta_crop_data.to_csv('../../Datasets/econ_crop_data/final_crop_economic_data.csv')
