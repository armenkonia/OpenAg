...
crop_data = pd.read_csv(r"C:\Users\armen\Desktop\COEQWAL\Scripts\landiq crop\proxy crop finder\crops_county.csv")
#%%
...
counties_hr_data = pd.read_csv('C:/Users/armen/Desktop/COEQWAL/Datasets/counties_HR.csv')
...
hr_avg_prices_with_neighbors = hr_avg_prices_df.merge(
    counties_hr_data[['HR_NAME', 'Neighboring HR']],
    how='left',
    on='HR_NAME'
).drop_duplicates()
...
counties_hr_df = pd.read_csv('C:/Users/armen/Desktop/COEQWAL/Datasets/counties_HR.csv')
...
hr_avg_yields_with_neighbors = hr_avg_yields_df.merge(
    counties_hr_df[['HR_NAME', 'Neighboring HR']],
    how='left',
...
crop_data = crop_data.iloc[:,2:]
crop_data.to_csv(r"C:\Users\armen\Desktop\COEQWAL\Datasets\Outputs\meta_crop_economic_data.csv")

crop_data = crop_data[['Crop_OpenAg', 'County', 'HR_NAME', 'ACRES','usda crop','final_price','final_yield']]
crop_data.to_csv(r"C:\Users\armen\Desktop\COEQWAL\Datasets\Outputs\crop_economic_data.csv")
